...
/** The static threshold that is set at the backend for each event.
 * If an event takes longer than this threshold, it is counted as blocking.
 * Currently, all events that are below this threshold, once set, will never arrive
 * at the frontend.
 * In the future, this hsould be configurable by the user.
 */

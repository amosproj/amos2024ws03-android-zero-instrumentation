...
val processesList =
    listOf(
        ...
        Process(
            ...
            ppid = 2u,
            state = "S",
            cmd = Comm(name = "rcu_exp_par_gp_kthread_worker"),
        ),
        ...
        Process(
            ...
            ppid = 2u,
            state = "S",
            cmd = Comm(name = "dmabuf-deferred-free-worker"),
        ),
        ...
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/prng_seeder")),
        ),
        ...
        Process(
            ...
            ppid = 2u,
            state = "S",
            cmd = Comm(name = "irq/18-goldfish_pipe_dprctd"),
        ),
        Process(
            pid = 170u,
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/vendor/bin/qemu-props")),
        ),
        ...
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/carwatchdogd")),
        ),
        Process(
            pid = 180u,
            ppid = 1u,
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf("/vendor/bin/hw/android.hardware.automotive.evs-aidl-default-service")
                ),
        ),
        Process(
            pid = 182u,
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf("/vendor/bin/hw/android.hardware.automotive.vehicle@V3-emulator-service")
                ),
        ),
        ...
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/tombstoned")),
        ),
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/vendor/bin/hw/android.device.generic.car.emulator@1.0-protocanbus-service"
                    )
                ),
        ),
        Process(
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf("/vendor/bin/hw/android.hardware.camera.provider@2.7-service-google")
                ),
        ),
        Process(
            pid = 403u,
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf("/vendor/bin/hw/android.hardware.graphics.allocator@3.0-service.ranchu")
                ),
        ),
        Process(
            pid = 405u,
        ...
        Process(
            ...
            state = "S",
            cmd =
                Cmdline(listOf("/vendor/bin/hw/android.hardware.graphics.composer3-service.ranchu")),
        ),
        Process(
            pid = 423u,
            ppid = 1u,
        ...
        Process(
            ...
            state = "S",
            cmd =
                Cmdline(listOf("/vendor/bin/hw/android.hardware.automotive.ivn@V1-default-service")),
        ),
        Process(
            pid = 425u,
            ppid = 1u,
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/vendor/bin/hw/android.hardware.automotive.remoteaccess@V2-default-service"
                    )
                ),
        ),
        Process(
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/apex/com.android.hardware.authsecret/bin/hw/android.hardware.authsecret-service.example"
                    )
                ),
        ),
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/apex/com.android.hardware.cas/bin/hw/android.hardware.cas-service.example"
                    )
                ),
        ),
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/apex/com.android.hardware.neuralnetworks/bin/hw/android.hardware.neuralnetworks-service-sample-all"
                    )
                ),
        ),
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/apex/com.android.hardware.neuralnetworks/bin/hw/android.hardware.neuralnetworks-service-sample-limited"
                    )
                ),
        ),
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/apex/com.android.hardware.neuralnetworks/bin/hw/android.hardware.neuralnetworks-shim-service-sample"
                    )
                ),
        ),
        Process(
            ...
            cmd =
                Cmdline(
                    listOf(
                        "/apex/com.android.hardware.rebootescrow/bin/hw/android.hardware.rebootescrow-service.default"
                    )
                ),
        ),
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/audioserver")),
        ),
        Process(
            pid = 462u,
            ppid = 1u,
        ...
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/gpuservice")),
        ),
        Process(
            pid = 473u,
            ppid = 1u,
        ...
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/traced_probes")),
        ),
        ...
        Process(
            ...
            cmd =
                Cmdline(
                    listOf("/vendor/bin/bt_vhci_forwarder", "-virtio_console_dev=/dev/bluetooth0")
                ),
        ),
        Process(
            pid = 538u,
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/cameraserver")),
        ),
        ...
        Process(
            ...
            ppid = 1u,
            state = "S",
            cmd = Cmdline(listOf("/system/bin/mediaserver")),
        ),
        ...
        Process(
            ...
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.systemui")),
        ),
        Process(
            pid = 1139u,
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("android.ext.services")),
        ),
        Process(
            pid = 1181u,
            ppid = 390u,
        ...
        Process(
            ...
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.bluetooth")),
        ),
        Process(
            pid = 1284u,
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.car.rotary")),
        ),
        Process(
            pid = 1413u,
            ppid = 390u,
        ...
        Process(
            ...
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("android.car.cluster")),
        ),
        Process(
            pid = 1696u,
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.car.radio")),
        ),
        Process(
            pid = 1715u,
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.car.media")),
        ),
        Process(
            pid = 1764u,
            ppid = 390u,
        ...
        Process(
            ...
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.car.dialer")),
        ),
        Process(
            pid = 2128u,
            ppid = 390u,
        ...
        Process(
            ...
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("android.process.media")),
        ),
        Process(
            pid = 3295u,
            ppid = 390u,
            state = "S",
            cmd = Cmdline(listOf("com.android.keychain")),
        ),
        Process(
            pid = 3311u,
            ppid = 390u,
        ...
        Process(
            ...
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u8:0-events_unbound"),
        ),
        ...
        Process(
            ...
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u9:0-blk_crypto_wq"),
        ),
        Process(
            pid = 12935u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/3:0-mm_percpu_wq"),
        ),
        ...
        Process(
            ...
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/1:1-virtio_vsock"),
        ),
        Process(
            pid = 14003u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/1:2-virtio_vsock"),
        ),
        Process(
            pid = 14014u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u9:1-blk_crypto_wq"),
        ),
        Process(
            pid = 14028u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u8:2-events_unbound"),
        ),
        Process(
            pid = 14517u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u9:2-blk_crypto_wq"),
        ),
        Process(
            pid = 14518u,
            ppid = 2u,
        ...
        Process(
            ...
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u8:1-events_unbound"),
        ),
        Process(
            pid = 14617u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/1:0-virtio_vsock"),
        ),
        Process(
            pid = 14626u,
            ppid = 1u,
        ...
        Process(
            ...
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u8:3-events_unbound"),
        ),
        Process(
            pid = 14660u,
            ppid = 2u,
            state = "I",
            cmd = Comm(name = "kworker/u8:4-events_unbound"),
        ),
        Process(
            pid = 14667u,
            ppid = 501u,
